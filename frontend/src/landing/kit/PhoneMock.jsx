...
const TELEGRAM_BOT_URL = 'https://t.me/monvouz_bot';

// Ilova hali do'konlarda chiqmagani uchun Telegram bot — hoziroq ishlaydigan
// muqobil "olish" yo'li sifatida ko'rsatiladi.
export function TelegramBtn({ openLabel }) {
  return (
    <a
      ...
      style={{
        display: 'inline-flex', alignItems: 'center', gap: 12,
        padding: '10px 18px', background: '#229ED9', color: '#fff',
        borderRadius: 12, textDecoration: 'none', minWidth: 168,
      }}>
      <TelegramLogo size={26}/>
      <span>
        <span style={{ display: 'block', fontSize: 9.5, opacity: 0.85, letterSpacing: 0.6, textTransform: 'uppercase' }}>
          {openLabel || 'Open in'}
        </span>
        <span style={{ display: 'block', fontFamily: 'var(--k-display)', fontSize: 17, fontWeight: 600, marginTop: -1 }}>
          Telegram
